        ...
        <div className="container mt-4">
                {/*Ostatnie filmy start*/}
                    ...
                    <div className= "row">
                        ...
                        <div className="col-md-3">
                            <div className="card">
                            <Link to="/about"><img src ="logo512.png" className="card-img-top" alt="foto"/></Link>
                                    <div className="card-body">
                                        <h5 className="card-title">
                                            <a href= "#" className= "btn btn-primary">Tytuł filmu</a>
                 ...
                 {/*Ostatnie filmy end*/}
                  ...
                  <h3 className = "pb-1 mb-4">Popularne filmy</h3>
                   ...
                   {/*Popularne filmy end*/}
                   {/*Popularni Autorzy filmów start */}
                   <h3 className = "pb-1 mb-4">Popularni autorzy filmów</h3>
                    <div className= "row">
                        <div className="col-md-3">
                            <div className="card">
                                    <a href ="#"> <img src ="logo512.png" className="card-img-top" alt="foto"/></a>
